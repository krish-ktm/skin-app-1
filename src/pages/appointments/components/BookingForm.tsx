          ...
          >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 w-full max-w-3xl">
              <motion.button
                ...
                className={`
                  group p-8 bg-white rounded-2xl transition-all duration-300
              ...
              >
                <div className="transform group-hover:scale-110 transition-transform duration-300">
                  <div className="p-5 bg-blue-50 rounded-full group-hover:bg-blue-100">
                    <UserCheck className="w-12 h-12 text-blue-500" />
                  </div>
                </div>
                <div className="text-center space-y-2">
                  <h4 className="text-xl font-semibold text-gray-800">Returning Patient</h4>
                  <p className="text-gray-600">Quick access with your Case ID</p>
                </div>
              </motion.button>
              ...
              >
                <div className="transform group-hover:scale-110 transition-transform duration-300">
                  <div className="p-5 bg-green-50 rounded-full group-hover:bg-green-100">
                    <UserPlus className="w-12 h-12 text-green-500" />
                  </div>
                </div>
                <div className="text-center space-y-2">
                  <h4 className="text-xl font-semibold text-gray-800">New Patient</h4>
